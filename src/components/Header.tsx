  ...
  return (
    <div className="bg-[#eeebfe] block w-full p-6 pl-16 rounded-lg shadow hover:bg-gray-100">
      <div className="mt-[10%]">
       ...
       <div>
       <button type="button" className="mt-24 text-white bg-[#050708] hover:bg-[#050708]/90 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-lg text-sm px-5 py-1 text-center inline-flex items-center dark:focus:ring-[#050708]/50 dark:hover:bg-[#050708]/30 mr-2 mb-2">
